...
def _save_currently_asking(form, collected_data, user_id=WEB_USER):
...
@router.post("/reset")
def reset():
    write_json("active_form.json", None, user_id=WEB_USER)
    write_json("collected_data.json", {}, user_id=WEB_USER)
    write_json("messages.json", [], user_id=WEB_USER)
    write_json("currently_asking.json", {"field_id": None}, user_id=WEB_USER)
...
def chat(req: ChatRequest):
    ...
    write_json("collected_data.json", collected_data, user_id=WEB_USER)
    ...
    write_json("currently_asking.json", {"field_id": new_asking}, user_id=WEB_USER)
